...
const SearchMovie = () => {
  ...
  return (
    <div className='flex justify-center pt-[10%] w-[100%] h-screen bg-black'>
      <form onSubmit={submitHandler} className='w-[50%]'>
        <div className='flex justify-between shadow-mg border-2 p-2 border-gray-200 rounded-lg w-100%'>
